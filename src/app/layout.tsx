...
export const metadata: Metadata = {
  ...
  description: "Онлайн-запись к терапевту, неврологу, эндокринологу в центре «Биосфера ДВ». Адрес: пр-т 100-летия Владивостока, 84а. Звоните: +7 (924) 338-81-89",
  keywords: "запись на прием Владивосток, терапевт Владивосток, невролог Владивосток, эндокринолог Владивосток, медицинский центр Биосфера ДВ, диагностика Владивосток, записаться к врачу онлайн, Приморский край",
  openGraph: {
    title: "Биосфера ДВ",
